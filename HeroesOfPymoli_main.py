...
purchase_value_df = pd.DataFrame(purchase_data_df)
purchase_value_df = purchase_data_df.sort_values("Total Purchase Value")
...
most_popular = purchase_data_df.sort_values("Purchase Count", ascending=False)
most_popular.head()
...
purchase_value_df = pd.DataFrame(purchase_data_df)
purchase_value_df = purchase_data_df.sort_values("Total Purchase Price", ascending=False)
purchase_value_df.head()
